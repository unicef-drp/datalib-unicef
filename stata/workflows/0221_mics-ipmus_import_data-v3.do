...
foreach file in `list' {
    ...
    if strmatch("`file'","*mics*") == 1 {
        ...
        * extract type of survey: bh ch fs hh hl mn wm
        local type = word(subinstr(subinstr("`file'","_"," ",.),".dta","",.), 3)
        di "`type'"
        ...
        * create svy_id
        ...
        foreach id in `r(levels)' {
            ...
            di "`id'"
                ...
                * Define file paths
                local target_file "${datalib}/`ctry'/`ctry'_`year'_`svy'/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'/Data/Stata/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'_`type'.dta"
                ...
                *create ctry folder if it does not exist
                cap: mkdir "${datalib}/`ctry'/`ctry'_`year'_`svy'/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'"
                if (_rc==0) {
                    noi di "Created `ctry'_`year'_`svy' in datalib folder and subfolders"
                    cap: mkdir "${datalib}/`ctry'/`ctry'_`year'_`svy'/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'/Doc"
                    cap: mkdir "${datalib}/`ctry'/`ctry'_`year'_`svy'/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'/Data"
                    cap: mkdir "${datalib}/`ctry'/`ctry'_`year'_`svy'/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'/Programs"
                    cap: mkdir "${datalib}/`ctry'/`ctry'_`year'_`svy'/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'/Data/Original"
                    cap: mkdir "${datalib}/`ctry'/`ctry'_`year'_`svy'/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'/Data/Stata"
                    cap: mkdir "${datalib}/`ctry'/`ctry'_`year'_`svy'/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'/Data/Other"
                }   
                else {
                    noi di "`ctry'_`year'_`svy' in datalib folder already exists"
                }
                ...
                * save
                save "${datalib}/`ctry'/`ctry'_`year'_`svy'/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'/Data/Stata/`ctry'_`year'_`svy'_v01_M_v03_A_`clct'_`type'.dta", replace
